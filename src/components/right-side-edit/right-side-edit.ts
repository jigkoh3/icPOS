...
import { CreateDiscountModalPage } from '../../pages/create-discount-modal/create-discount-modal';
...
export class RightSideEditComponent {
  ...
  openCreateDiscount() {
    ...
    let createDiscountModal = this.modalCtrl.create(CreateDiscountModalPage, {}, opts);
